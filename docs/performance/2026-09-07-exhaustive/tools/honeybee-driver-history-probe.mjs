...
async function memory(phase){for(let i=0;i<3;i++){globalThis.gc();await delay(0);}await delay(0);phases.push({phase,memoryUsage:process.memoryUsage()});}
