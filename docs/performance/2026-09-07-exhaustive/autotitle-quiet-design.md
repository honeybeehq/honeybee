...
This is an implementation decision, not performance acceptance. Unit1 is being implemented in an isolated322815d9 worktree. No automatic-title cache is integrated in main.
