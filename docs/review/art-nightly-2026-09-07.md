...
- Medium: Same-millisecond Cell receipts could select an older UUID instead of the latest insertion. Source `4d0f34dd19798c9f86cc914f4c4f03030dc482c4`. Repair `0472a91c99d7a75c19429b6bffc9988e57c2a272`. Included in this publication branch as `f868ea70fa7a226a2072d2b34dbad2c8a79b80e1`.
- Medium: Retained Cell RPC and CLI optional arguments silently accepted wrong types. Source `4d0f34dd19798c9f86cc914f4c4f03030dc482c4`. Repair `0472a91c99d7a75c19429b6bffc9988e57c2a272`. Included in this publication branch as `f868ea70fa7a226a2072d2b34dbad2c8a79b80e1`.
- Medium: External lineage ID collisions appeared as local children. Source `eb4a77c2a5356864bd9c495b3deb290ab04860e4`. Repair `ac33d942ccd7f522092cd3e8f7d7029e53a0a46a`. Included in this publication branch as `663aaf39e5baeaa1cf51ffc21aa1ea6e70e23909`.
...
- Low: Evidence manifest checksummed CRLF bytes instead of the committed LF CSV. Source `487972cf1f6a7818766b422d116d6f997c0c8129`. Repair `aad40964f9e27981abce0cc12f1b70b6b48e16b0`. Included in this publication; all 1,875 current manifest entries pass after rebasing.
- Low: Archived dedup fixture count field excluded scenario-specific messages. Source `6d2677b126ec9e8b11992954bb6bc3c27311bbf1`. Repair `ab0d9599d2fffdcfaeb7c5e855672d5c73187bf4`. Included in this publication as an erratum; immutable archives preserved. A fresh original-v3 probe confirmed 20 background, 21 wide, and 276 probe rows.

## Publication and validation

This publication starts at freshly fetched origin/main `02aa424e486d36f2f828eb710ce217575e277e57`. The original frozen review base remains `98cc89c3180b25272c31f67e438adea1380921c2`. It includes lineage repair `663aaf39e5baeaa1cf51ffc21aa1ea6e70e23909`, Cell repair `f868ea70fa7a226a2072d2b34dbad2c8a79b80e1`, manifest correction `aad40964f9e27981abce0cc12f1b70b6b48e16b0`, and fixture-count erratum `ab0d9599d2fffdcfaeb7c5e855672d5c73187bf4`. The two code integrations match their reviewed source commits by stable patch ID and identical added/removed lines and paths. Incoming main adds a separately reviewed mailbox-membership method to the same store file, so its complete before/after blobs differ. The [rebase proof](art-nightly-2026-09-07-main-fix-equivalence.json) records this distinction. The publication guard first stopped when the owner advanced main by 13 commits. All 13 incoming SHAs were already reviewed members of the frozen 143-candidate set. [Their exact outcomes](art-nightly-2026-09-07-incoming-main.json) are retained; they add no new candidate identities. Only Art's five unpublished commits were rebased. No unmerged feature branch was brought into main.

On the final rebased publication branch, all 42 combined mailbox-membership, automatic-title cache, lineage and Cell tests pass. All 1,875 current manifest entries match. Both TypeScript checks and the full build pass. The 24 failing legacy test blobs and all 40 associated primary source/harness paths remain identical to frozen main, preserving the broad-suite qualification below. [The exact blob proof](art-nightly-2026-09-07-legacy-callsite-equivalence.json) records this comparison.
