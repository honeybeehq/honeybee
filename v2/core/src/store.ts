...
export interface BeeViewRow {
  ...
  /** v21 — active or retained Cell; null when none. */
  cell: CellRow | null;
}
...
export class CoreStore {
  ...
  // -------------------------------------------------------------------------
  // v21 — cells registry + bee_moves + cell_ops
  // -------------------------------------------------------------------------
